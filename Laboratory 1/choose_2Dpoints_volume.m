...
if volume_size == 3 %small at edge
...
if volume_size == 4 % small in middle
    volume_LAT = [8 9 14 15 30 31 35 36]; %[9 14 16 20 31 35 37 40]; %[8 10 14 16 30 32 35 37]; 
    volume_PA0 = [8 9 14 15 31 32 36 37]; %[9 14 16 21 32 36 38 42]; %[8 10 14 16 31 33 36 38];
    
end

if volume_size == 5 % only one plane
    volume_LAT = [24 28 43 47 30 32 39 41];
    volume_PA0 = [25 29 45 49 31 33 41 43];
end

if volume_size == 6 %volume question 2.3
